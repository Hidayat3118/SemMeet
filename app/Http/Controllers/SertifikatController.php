...
class SertifikatController extends Controller
{
    ...
    public function view($id)
    {
        ...
        // Ambil foto_multi dari seminar dan decode
        $fotoMulti = json_decode($sertifikat->pendaftaran->seminar->foto_multi ?? '[]');

        $pdf = Pdf::loadView('sertifikat.pdf', compact('sertifikat', 'pembicara', 'fotoMulti'))
    ...
    public function download($id)
    {
        ...
        $pdf = Pdf::loadView('sertifikat.pdf', compact('sertifikat', 'fotoMulti'))
            ->setPaper('a4', 'landscape');
