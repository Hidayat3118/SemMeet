<x-filament::page>
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        <div class="p-6 bg-blue-50 shadow rounded-xl flex items-center gap-4">
        ...
        <div class="p-6 bg-green-50 shadow rounded-xl flex items-center gap-4">
        ...
        <div class="p-6 bg-yellow-50 shadow rounded-xl flex items-center gap-4">
            <div class="text-4xl text-yellow-600">
                <i class="fas fa-gift"></i>
            </div>
            <div>
                <h2 class="text-sm text-gray-600 font-semibold uppercase">Voucher Terpakai</h2>
                <p class="text-3xl font-bold text-yellow-700">{{ \App\Models\Voucher::count() }}</p>
            </div>
        </div>

        <div class="p-6 bg-purple-50 shadow rounded-xl flex items-center gap-4">
            <div class="text-4xl text-purple-600">
                <i class="fas fa-clipboard-list"></i>
            </div>
            <div>
                <h2 class="text-sm text-gray-600 font-semibold uppercase">Pendaftaran</h2>
