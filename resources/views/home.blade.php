            ...
            <div class=" mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 items-center gap-10  max-w-2xl lg:max-w-7xl">
                <div class="space-y-6 text-center md:text-left">
                    ...
                    <div class="flex space-x-2 justify-center md:justify-start">
                        <a class="group relative inline-block text-sm font-medium text-white focus:ring-3 focus:outline-hidden cursor-pointer"
                            href="{{ route('register') }}">
                            <span
                            ...
                            <span class="relative block border border-current bg-blue-500 px-6 py-3 rounded-full">Daftar
                                Sekarang</span>
                        </a>
                        <a href="/seminar"
        ...
        <section class="text-center py-20 px-4 md:px-0 max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/512/158/158737.png" alt="Upgrade"
                ...
                <div
                    class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl border border-gray-300 transition-shadow duration-300 group">
                    <img src="https://cdn-icons-png.flaticon.com/512/25/25363.png" alt="Jaringan"
                        class="w-20 h-20 mx-auto mb-6 transition-transform duration-300 group-hover:scale-110">
                ...
                <div
                    class="bg-white p-6 rounded-xl shadow-md hover:shadow-xl border border-gray-300 transition-shadow duration-300 group">
                    <img src="https://cdn-icons-png.flaticon.com/512/1828/1828673.png" alt="Update"
                        class="w-20 h-20 mx-auto mb-6 transition-transform duration-300 group-hover:scale-110">
