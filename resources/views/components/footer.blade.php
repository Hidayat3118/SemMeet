          ...
          <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
            <form class="w-full">
              ...
              >
                ...
                <button
                  class="mt-1 w-full bg-blue-500 px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-none hover:bg-blue-600 sm:mt-0 sm:w-auto sm:shrink-0"
                >
                  Sign Up
                </button>
              </div>
