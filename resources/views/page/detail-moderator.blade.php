            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                ...
                <div class="md:col-span-1 flex flex-col justify-center">
                    <div class="flex justify-center">
                        <img src="https://t3.ftcdn.net/jpg/02/43/12/34/360_F_243123463_zTooub557xEWABDLk0jJklDyLSGl2jrr.jpg" alt="Foto Moderator"
                    ...
                    <div class="">
                        ...
                        <div class="pb-4 text-justify">
                            ...
                            <p class="text-gray-700 mt-2 md:mt-3">
                                ...
                                menjadi
                                Moderator dalam konferensi teknologi nasional dan internasional.
                            </p>
                        </div>
